...
export const loginAC = (user,navigate)=>{
  return function(dispatch){
    ...
    // axios.defaults.headers.post['Access-Control-Allow-Origin'] = '*';
    // axios.post('http://localhost:8080/login',{user},{headers: {'Access-Control-Allow-Origin':'*'}}).then(function (response) {
...
export const checkAuthAC = (navigate)=>{
  return async function(dispatch){
    await axios.get('http://localhost:8080/user').then(function (response) {
